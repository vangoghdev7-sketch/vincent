...
API_REGISTRY = [
    ...
    # ── Multi-AI Swarm & LLM Router Providers ───────────────────────
    {
        "id": "openai_api_key",
        "env_key": "OPENAI_API_KEY",
        "name": "OpenAI — API Key",
        "description": "API Key for OpenAI models (GPT-4o, GPT-4o-mini, o1, o3-mini). Get a key at platform.openai.com/api-keys.",
        "category": "AI / LLM Swarm",
    ...
    },
    {
        ...
        "description": "API Key for Anthropic Claude models (Claude 3.7 Sonnet, Claude 3.5 Sonnet/Haiku). Get a key at console.anthropic.com.",
        "category": "AI / LLM Swarm",
    ...
    },
    {
        ...
        "description": "API Key for Google Gemini models (Gemini 2.5 Pro, 2.5 Flash, 2.0 Flash). Get a key at aistudio.google.com.",
        "category": "AI / LLM Swarm",
    ...
    },
    {
        ...
        "description": "API Key for DeepSeek models (DeepSeek-V3, DeepSeek-R1 Reasoner). Get a key at platform.deepseek.com.",
        "category": "AI / LLM Swarm",
    ...
    },
    {
        ...
        "description": "API Key for xAI Grok models (Grok-2, Grok-Vision). Get a key at console.x.ai.",
        "category": "AI / LLM Swarm",
    ...
    },
    {
        ...
        "description": "Base URL for local Ollama instance (default: http://127.0.0.1:11434). Zero-key, local privacy.",
        "category": "AI / LLM Swarm",
    ...
    },
    {
        ...
        "description": "API Key for Moonshot Kimi models (K1.5, Moonshot-v1). Get a key at platform.moonshot.cn.",
        "category": "AI / LLM Swarm",
    ...
    },
    {
        ...
        "description": "API Key for MiniMax models (abab6.5s, minimax-text-01). Get a key at platform.minimaxi.com.",
        "category": "AI / LLM Swarm",
    ...
    },
    {
        ...
        "name": "Qwen / DashScope — API Key",
        "description": "API Key for Alibaba Qwen models (Qwen-Max, Qwen-Plus, Qwen-Coder). Get a key at dashscope.aliyun.com.",
        "category": "AI / LLM Swarm",
        "url": "https://dashscope.aliyun.com/",
        "required": False,
    },
    {
        "id": "vincent_ai_gateway_url",
        "env_key": "VINCENT_AI_GATEWAY_URL",
        "name": "Vincent AI Swarm Gateway URL",
        "description": "Unified Multi-AI Gateway URL (default: http://127.0.0.1:20128). Runs Vincent AI Router locally.",
        "category": "AI / LLM Swarm",
        "url": "http://localhost:20128",
        "required": False,
    },
    {
        "id": "openclaw_hmac_secret",
        "env_key": "OPENCLAW_HMAC_SECRET",
        "name": "OpenClaw HMAC Secret",
        "description": "Shared secret for OpenClaw AI autonomous agent skill authentication. Generate via Settings or UI Bootstrap.",
        "category": "AI / LLM Swarm",
        "url": None,
        "required": False,
    },
